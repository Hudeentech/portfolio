...
function normalizeTimeout(time) {
  ...
  return { connect: delay2, socket: delay2 };
}
...
// node_modules/@sanity/client/dist/_chunks/browserMiddleware-FL0Mlm8l.js
...
function shouldRetry(err, attempt, options) {
  ...
  if ((isSafe || isQuery) && isRetriableResponse)
    return true;
  return retry2.shouldRetry(err, attempt, options);
}
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-LDHMEOVo-VWS45GSF.js").then(function(n) {
...
function _dataRequest(client, httpRequest, endpoint, body, options = {}) {
  ...
  const { timeout: timeout2, token, tag, headers } = options;
...
function _listen(query, params, opts = {}) {
  ...
  return new Observable((observer) => {
    ...
    async function getEventSource() {
      const { default: EventSource } = await import("./browser-N7NE4VPU.js");
...
function defineCreateClientExports(envMiddleware2, ClassConstructor) {
  ...
  const createClient = (config2) => new ClassConstructor(
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GVDS5QPW.js.map
